...
describe("black to enter 2 from the bar, with white blocking", () => {
  ...
  test("roll of [1,1], black enters and moves", () => {
    ...
    expect(moveset(moves)).toEqual(
      setify([
        [[c.BAR,23],[c.BAR,23],[23,22],[23,22]],
        [[c.BAR,23],[c.BAR,23],[23,22],[22,21]],
        [[c.BAR,23],[c.BAR,23],[23,22],[7,6]],
        [[c.BAR,23],[c.BAR,23],[7,6],[7,6]],
        [[c.BAR,23],[c.BAR,23],[7,6],[6,5]],
        [[c.BAR,23],[c.BAR,23],[23,22],[5,4]],
        [[c.BAR,23],[c.BAR,23],[7,6],[5,4]],
        [[c.BAR,23],[c.BAR,23],[5,4],[5,4]],
        [[c.BAR,23],[c.BAR,23],[5,4],[4,3]],
      ])
    )
  });
})
